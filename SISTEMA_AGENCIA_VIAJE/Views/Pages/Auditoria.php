  ...
  <div class="box box-default">
    ...
    <div class="box-body">
      <form class="form-inline" method="get" action="Auditoria" style="margin:0;">
        ...
        <div class="form-group">
          <label>Tabla</label>
          <input type="text" name="tabla" class="form-control" placeholder="usuarios, expedientes..."
                 value="<?php echo h($tab); ?>">
        </div>
        <div class="form-group" style="min-width:320px;">
          <label>Buscar</label>
          <input type="text" name="q" class="form-control" style="width:100%;"
                 placeholder="Valores antiguos/nuevos, IP, UserAgent"
                 value="<?php echo h($q); ?>">
        </div>
              ...
              <td colspan="8">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <pre style="max-height:260px; overflow:auto;"><?php echo h(try_prety_json($r['valores_nuevos'] ?? '')); ?></pre>
                  </div>
                </div>
              </td>
            </tr>
